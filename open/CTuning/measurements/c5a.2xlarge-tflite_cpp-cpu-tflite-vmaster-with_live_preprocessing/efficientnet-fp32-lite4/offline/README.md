...
cm pull repo ctuning@mlcommons-ck --checkout=3b97ffa1d34258d5e654da47f582df968d838a83
...
Platform: c5a.2xlarge-tflite_cpp-cpu-tflite-vmaster-with_live_preprocessing

### Accuracy Results 
`acc`: `80.676`, Required accuracy for closed division `>= 75.6954`

### Performance Results 
`90th percentile latency (ns)`: `141404491.0`
