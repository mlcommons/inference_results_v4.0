...
default_log_output_path_dir = f"run_outputs/job_{job_id}"
...
def get_args():
    ...
    parser.add_argument("--output-log-dir", type=str, default=default_log_output_path_dir, help="Where logs are saved")
    ...
    parser.add_argument("--engine-dir", default="engine", type=str, help="path to TensorRT engine directory")
    parser.add_argument("--batch-size", default=8, type=int, help="batch_size to be used for inference")
