...
class Fields(Enum):
    ...
    open_model_path: Field = Field(
        "open_model_path",
        "Path to additional pytorch/onnx model weights for open division",
        value_type=str)
    ...
    model_opt: Field = Field(
        ...
        value_type=str,
        supported_actions=_HARNESS_ACTIONS,
        argparse_opts={"choices": ["NoOpt", "Pruned", "DeepCache", "DeepCachePruned", "Sparse"]})
