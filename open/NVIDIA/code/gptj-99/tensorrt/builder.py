...
class GPTJ6BEngineBuilderOp(TRTBuilder,
    ...
    def __init__(self,
                 ...
                 open_model_path: str = "build/open-models/GPTJ-6B/",
                 # TODO: This should be a relative path within the ScratchSpace.
                 fp8_quant_model_path: str = "FP8-quantized/",
        ...
        self.fp8_quant_model_path = Path(open_model_path) / Path(fp8_quant_model_path)
        ...
        self.fp16_model_path = Path(open_model_path) / Path(fp16_model_path)
        ...
        if not SystemClassifications.is_orin():
            if self.use_fp8:
                ...
                raise NotImplementedError("Only fp8 supported as of now. Set precision to FP16 and use_fp8 to True. If you need to perform quantization, please refer to README.md")
        else:
        ...
        if self.precision == "fp8":
            raise NotImplementedError("To enable FP8 precision, set precision to FP16 and use_fp8 to True.")
