...
DIRECT_CONNECTS: Dict[str, str] = {
    'shallowunet_down.0.res_samples.0': 'unet_down.0.res_samples.0',
    'shallowunet_down.0.res_samples.1': 'unet_down.0.res_samples.1',
    'shallowunet_up.1.sample': 'unet_up.1.sample',
}
...
class SDXLEngine():
    ...
    def enable_cuda_graphs(self, buffers: SDXLBufferManager, stream: int = 2):
        ...
        assert self.model_class is not None, "only support unet and shallowunet cuda graphs"
        ...
        for actual_batch_size in range(self.min_batch_size, self.max_batch_size + 1, 2):
            ...
            sample_inputs = yield_inputs(self.model_class(max_batch_size=batch_size, precision='int8').get_sample_input(batch_size))
...
class SDXLBufferManager:
    ...
    def __init__(self, engines_dict: Dict[str, SDXLEngine], direct_connects: Dict[str, str] = {}, device: str = 'cuda'):
        ...
        #     'unet_time_ids',
        #     'shallowunet_sample',
        #     'shallowunet_timestep',
        #     'shallowunet_text_embeds',
        #     'shallowunet_time_ids',
        #     'shallowunet_down.0.res_samples.0',
        #     'shallowunet_down.0.res_samples.1',
        #     'shallowunet_up.1.sample',
        # ]
        ...
        #     'unet_latent',
        #     'unet_down.0.sample',
        #     'unet_down.0.res_samples.0',
        #     'unet_down.0.res_samples.1',
        #     'unet_down.0.res_samples.2',
        #     'unet_down.1.sample',
        #     'unet_down.1.res_samples.0',
        #     'unet_down.1.res_samples.1',
        #     'unet_down.1.res_samples.2',
        #     'unet_down.2.sample',
        #     'unet_down.2.res_samples.0',
        #     'unet_down.2.res_samples.1',
        #     'unet_mid.0.sample',
        #     'unet_up.0.sample',
        #     'unet_up.1.sample',
        #     'shallowunet_latent',
    ...
    def __initialize(self):
        ...
        for network_name, sdxl_engine in self.engines_dict.items():
            ...
            for idx in range(trt_engine.num_io_tensors):
                ...
                tensor_shape: list[int] = list(trt_engine.get_tensor_shape(tensor_name))
                ...
                if connect_name not in self.buffers:
                    buffer = torch.empty(tensor_shape, dtype=dtype).to(device=self.device)
                ...
                sdxl_engine.stage_tensor(tensor_name, buffer)
...
class TestPipeline:
    def __init__(
        ...
        engine_files: Dict[str, str] = {
            ...
            'ShallowUNetXl': 'stable-diffusion-xl-ShallowUNetXL-Offline-gpu-b1-fp16.custom_k_99_MaxP.plan',
        ...
        self.buffers = SDXLBufferManager(self.test_engine.engines, direct_connects=DIRECT_CONNECTS)
        ...
        self.test_engine.engines['unet'].enable_cuda_graphs(self.buffers)
        self.test_engine.engines['shallowunet'].enable_cuda_graphs(self.buffers)
...
class SDXLCore:
    def __init__(self,
        ...
        self.models = {
            ...
            'shallowunet': ShallowUNetXL(max_batch_size=gpu_batch_size, device=self.device),
        ...
        if self.use_graphs:
            ...
            self.engines['shallowunet'].enable_cuda_graphs(self.buffers)
    ...
    def _denoise_latent(self, actual_batch_size):
        ...
        self.buffers['shallowunet_text_embeds'] = text_embeds
        self.buffers['shallowunet_time_ids'] = self.add_time_ids[:actual_batch_size * 2]
        ...
        for step_index, timestep in enumerate(self.scheduler.timesteps):
            ...
            unet_model = 'shallowunet' if is_shallow else 'unet'
            ...
            for tensor_name, tensor_shape in self.models[unet_model].get_shape_dict(actual_batch_size).items():
...
if __name__ == '__main__':
    test_model = TestPipeline(
        ...
        engine_files={
            ...
            'ShallowUNetXl': 'stable-diffusion-xl-ShallowUNetXL-Offline-gpu-b8-int8.custom_k_99_MaxP.plan',
