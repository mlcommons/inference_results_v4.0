...
class ConfigRegistry(object):
    ...
    @classmethod
    def register(cls, harness_type: AliasedName, accuracy_target: AliasedName, power_setting: AliasedName, model_opt: AliasedName = ModelOpt.NoOpt):
        """
        ...
        """
        workload_setting = WorkloadSetting(harness_type, accuracy_target, power_setting, model_opt)
    ...
    def get(cls, benchmark, scenario, system, harness_type=HarnessType.Custom, accuracy_target=AccuracyTarget.k_99,
            power_setting=PowerSetting.MaxP, model_opt=ModelOpt.NoOpt):
        """
