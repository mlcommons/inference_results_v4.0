...
class OfflineGPUOpenBaseConfig(OfflineGPUBaseConfig):
    open_model_path = "build/open-models/GPTJ-6B/"
    pass

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP, ModelOpt.Pruned)
class H100_SXM_80GBx1(OfflineGPUOpenBaseConfig):
    system = KnownSystem.H100_SXM_80GBx1
    open_model_path = "build/open-models/GPTJ-6B-Pruned/"
    gpu_batch_size = 256
    use_fp8 = True
    offline_expected_qps = 50
    enable_sort = False
...
class H100_SXM_80GBx8(H100_SXM_80GBx1):
    system = KnownSystem.H100_SXM_80GBx8
    open_model_path = "build/open-models/GPTJ-6B-Pruned/"
    offline_expected_qps = 50 * 8
    enable_sort = False


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP, ModelOpt.Pruned)
class H100_SXM_80GBx1_HighAccuracy(H100_SXM_80GBx1):
    pass
