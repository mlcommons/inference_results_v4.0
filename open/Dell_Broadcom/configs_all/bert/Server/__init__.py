...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class XE9680_IntelXeon8480_NVIDIA_H100_SXM_80GBx8(ServerGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class XE9680_IntelXeon8480_NVIDIA_H100_SXM_80GBx8_HighAccuracy(ServerGPUBaseConfig):
    system = KnownSystem.XE9680_IntelXeon8480_NVIDIA_H100_SXM_80GBx8
    # H100_SXM_80GBx1
    use_small_tile_gemm_plugin = False
    #use_graphs = False
