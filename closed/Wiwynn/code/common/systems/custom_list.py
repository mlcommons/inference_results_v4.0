...
custom_systems['ES200G2_L40Sx2'] = SystemConfiguration(host_cpu_conf=CPUConfiguration(layout={CPU(name="INTEL(R) XEON(R) GOLD 6538Y+", architecture=CPUArchitecture.x86_64, core_count=32, threads_per_core=2): 1}), host_mem_conf=MemoryConfiguration(host_memory_capacity=Memory(quantity=263.558968, byte_suffix=ByteSuffix.GB), comparison_tolerance=0.05), accelerator_conf=AcceleratorConfiguration(layout={KnownGPU.L40S.value: 2}), numa_conf=None, system_id="ES200G2_L40Sx2")
