...
class ES200G2_L40SX2_HighAccuracy(ES200G2_L40SX2):
    precision = "fp16"
    single_stream_expected_latency_ns = ES200G2_L40SX2.single_stream_expected_latency_ns * 2


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class ES200G2_L40SX2_Triton(ES200G2_L40SX2):
    use_triton = True
...
class ES200G2_L40SX2_HighAccuracy_Triton(ES200G2_L40SX2_HighAccuracy):
    use_triton = True
