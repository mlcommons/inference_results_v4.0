...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class H200_140GBx1(OfflineGPUBaseConfig):
    system = KnownSystem.H200_140GBx1
    gpu_batch_size = 896
    use_fp8 = True
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class H200_140GBx1_HighAccuracy(H200_140GBx1):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class H200_140GBx8(H200_140GBx1):
    system = KnownSystem.H200_140GBx8
    offline_expected_qps = 12 * 8


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class H200_140GBx8_HighAccuracy(H200_140GBx8):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class H200_140GB_TP2x1(OfflineGPUBaseConfig):
    system = KnownSystem.H200_140GBx2
    gpu_batch_size = 2048
    use_fp8 = True
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class H200_140GB_TP2x1_HighAccuracy(H200_140GB_TP2x1):
    pass
