...
def main(args):
    ...
    commandline entrance of the graphsurgeon. Example commands:
        python3 -m code.sdxl.tensorrt.sdxl_graphsurgeon --onnx-fpath=build/models/SDXL/onnx_models/unetxl/model.onnx --output-onnx-fpath=/tmp/unetxl_graphsurgeon/model.onnx
    """
    device_type = 'gpu'
