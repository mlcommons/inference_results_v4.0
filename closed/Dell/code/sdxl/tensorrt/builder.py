...
SDXLGraphSurgeon = import_module("code.sdxl.tensorrt.sdxl_graphsurgeon").SDXLGraphSurgeon
...
class SDXLCLIPWithProjBuilder(SDXLBaseBuilder,
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super().__init__(*args,
                         model=CLIPWithProj(max_batch_size=batch_size, precision='fp16', device='cuda'),
                         model_path=model_path,
                         batch_size=batch_size,
                         **kwargs)
