...
from code.sdxl.tensorrt.dataset import Dataset
from code.sdxl.tensorrt.network import (
    CLIP,
    CLIPWithProj,
    UNetXL,
    VAE
)
from code.sdxl.tensorrt.utilities import (
    PipelineConfig,
    numpy_to_torch_dtype_dict,
    calculate_max_engine_device_memory,
    nvtx_profile_start,
    nvtx_profile_stop,
    CUASSERT,
)
import code.sdxl.tensorrt.scheduler as mlpinf_scheduler
try:
...
class TestPipeline:
    def __init__(
        ...
        engine_files: Dict[str, str] = {
            'CLIP': 'sdxl-CLIP-Offline-gpu-b1-fp16.custom_k_99_MaxP.plan',
            'CLIPWithProj': 'sdxl-CLIPWithProj-Offline-gpu-b1-fp16.custom_k_99_MaxP.plan',
            'UNetXl': 'sdxl-UNetXL-Offline-gpu-b1-fp16.custom_k_99_MaxP.plan',
            'VAE': 'sdxl-VAE-Offline-gpu-b1-fp32.custom_k_99_MaxP.plan',
        }
    ):
...
class SDXLCore:
    def __init__(self,
        ...
        self.engines = {}
        self.buffers = None
        self.scheduler = mlpinf_scheduler.EulerDiscreteScheduler()
    ...
    def _denoise_latent(self, actual_batch_size):
        ...
        encoder_hidden_states = torch.concat([self.buffers['clip1_hidden_states'], self.buffers['clip2_hidden_states']], dim=-1)
        text_embeds = self.buffers['clip2_text_embeddings']
...
if __name__ == '__main__':
    test_model = TestPipeline(
        engine_path='/work/build/engines/H100-SXM-80GB-02x1/sdxl/Offline',
        engine_files={
            'CLIP': 'sdxl-CLIP-Offline-gpu-b8-fp16.custom_k_99_MaxP.plan',
            'CLIPWithProj': 'sdxl-CLIPWithProj-Offline-gpu-b8-fp16.custom_k_99_MaxP.plan',
            'UNetXl': 'sdxl-UNetXL-Offline-gpu-b8-int8.custom_k_99_MaxP.plan',
            'VAE': 'sdxl-VAE-Offline-gpu-b8-fp32.custom_k_99_MaxP.plan',
        }
    )
