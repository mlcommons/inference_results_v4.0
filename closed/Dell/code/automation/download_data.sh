...
function download_dlrm2() {
    ...
    rclone copy mlc-inference:mlcommons-inference-wg-public/model_weights ${model_dir}/model_weights -P
...
function download_gptj() {
    ...
    rclone config create mlc-inference s3 provider=Cloudflare \
        ...
        secret_access_key=fbea333914c292b854f14d3fe232bad6c5407bf0ab1bebf78833c2b359bdfd2b \
        endpoint=https://c2686074cb2caf5cbaf6d134bdba8b47.r2.cloudflarestorage.com
    rclone copy mlc-inference:mlcommons-inference-wg-public/gpt-j ${model_dir}/gpt-j -P
...
function download_stable_diffusion() {
    ...
    local dataset_dir=${data_dir}/dtype
    local model_dir=${data_dir}/model
    SD_CODE_DIR="${WORK_DIR}/../stable_diffusion/pytorch-cpu"
    mkdir -p ${model_dir}

    echo "Downloading stable_diffusion model..."
    rclone config create mlc-inference s3 provider=Cloudflare \
        access_key_id=f65ba5eef400db161ea49967de89f47b \
        secret_access_key=fbea333914c292b854f14d3fe232bad6c5407bf0ab1bebf78833c2b359bdfd2b \
        endpoint=https://c2686074cb2caf5cbaf6d134bdba8b47.r2.cloudflarestorage.com
    rclone copy mlc-inference:mlcommons-inference-wg-public/stable_diffusion_fp32 ${model_dir}/stable_diffusion_fp32 -P
