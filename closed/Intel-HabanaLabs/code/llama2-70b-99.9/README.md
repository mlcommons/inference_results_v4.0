...
CPU should be set to performance mode
```bash
echo performance | sudo tee /sys/devices/system/cpu/cpu*/cpufreq/scaling_governor
```

In order to verify CPU mode run
```bash
...
This README is located in [code/llama2-70b-99.9](./) directory corresponding to Intel HabanaLabs's submission for llama2-70b-99.9 benchmark.
...
Please note your HuggingFace authentication credentials as you may be required to provide them when cloninng below.
...
The Quantization Toolkit is described in the [documentation](https://docs.habana.ai/en/latest/PyTorch/Inference_on_PyTorch/Inference_Using_FP8.html#fp8-inference-using-hqt).