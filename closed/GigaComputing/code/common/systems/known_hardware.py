...
class KnownCPU(MatchableEnum):
    ...
    Intel_Xeon_Platinum_8592P = CPU(AliasedName('Intel(R) Xeon(R) Platinum 8592+', ("Intel(R) Xeon(R) Platinum 8592+",)),
                                    architecture=CPUArchitecture.x86_64, core_count=64, threads_per_core=MatchAllowList([1, 2]))
