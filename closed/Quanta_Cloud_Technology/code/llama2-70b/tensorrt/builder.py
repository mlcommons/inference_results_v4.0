...
class LLAMA2EngineBuilderOp(TRTBuilder,
    ...
    def __init__(self,
                 ...
                 fp8_quant_model_path: str = "build/models/Llama2/fp8-quantized-ammo/llama2-70b-tp2pp1-fp8/",
                 #fp8_quant_model_path: str = "build/models/Llama2/fp8-quantized-ammo/llama2-70b-tp4pp1-fp8/",
