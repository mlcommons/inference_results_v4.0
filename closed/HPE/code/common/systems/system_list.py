...
# Hopper systems
add_systems("H200_SXM_140GBx{}", "H200-140GBx{}", KnownCPU.Intel_Xeon_Platinum_8480C.value,
...
class SystemClassifications:
    ...
    def start_from_device_enabled(cls, sys):
        return sys in [
            KnownSystem.HPE_Cray_XD670_H100_SXM_80GBx8_TRT,
            KnownSystem.HPE_ProLiant_DL380a_H100_PCIe_80GBx4_TRT,
