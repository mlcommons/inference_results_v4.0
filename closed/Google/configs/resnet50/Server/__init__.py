...
class H100_SXM_80GBx1(ServerGPUBaseConfig):
    ...
    server_target_qps = 54750
    #server_target_qps = 63875
    #server_target_qps = 59312.5
    #server_target_qps = 57031.25
    #server_target_qps = 55890.625
    #server_target_qps = 55320.3125
    #server_target_qps = 55035.15625
    #server_target_qps = 54892.578125
    #server_target_qps = 54821.2890625
    #server_target_qps = 54785.6445313
    #server_target_qps = 54785.6445313
    use_cuda_thread_per_device = True
    use_graphs = True
    start_from_device = True
