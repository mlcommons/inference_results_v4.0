...
class H100_SXM_80GBx1(ServerGPUBaseConfig):
    ...
    #server_target_qps = 810
    #server_target_qps = 1215
    server_target_qps = 1417.5
    #server_target_qps = 1316.25
    #server_target_qps = 1366.875
    #server_target_qps = 1392.1875
    #server_target_qps = 1404.84375
    #server_target_qps = 1411.171875
    #server_target_qps = 1414.3359375
    #server_target_qps = 1415.91796875
    workspace_size = 60000000000
