...
class H100_SXM_80GBx8(H100_SXM_80GBx1):
    ...
    #server_target_qps = 437500
    #server_target_qps = 406250
    server_target_qps = 390625
...
class H100_SXM_80GBx8_HighAccuracy(H100_SXM_80GBx8):
    #server_target_qps = 250000
    #server_target_qps = 375000
    server_target_qps = 312500
    #server_target_qps = 343750
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxQ)
class H100_SXM_80GBx8_MaxQ(H100_SXM_80GBx8):
    server_target_qps = 48000 * 8
    power_limit = 450
