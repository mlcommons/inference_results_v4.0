...
class H100_SXM_80GB_TP2x1(ServerGPUBaseConfig):
    ...
    #server_target_qps = 18.184375
    server_target_qps = 18.1125
...
class H100_SXM_80GB_TP2x2(H100_SXM_80GB_TP2x1):
    ...
    server_target_qps = 18.184375 * 2


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class H100_SXM_80GB_TP2x4(H100_SXM_80GB_TP2x2):
    system = KnownSystem.H100_SXM_80GBx8
    #server_target_qps = 18.4 * 4 # INVALID
    #server_target_qps = 9.2 * 4
    #server_target_qps = 13.8 * 4
    #server_target_qps = 16.1 * 4
    #server_target_qps = 17.25 * 4
    #server_target_qps = 17.825 * 4
    #server_target_qps = 18.1125 * 4 # VALID,
    #server_target_qps = 18.25625 * 4 # INVALID
    server_target_qps = 18.184375 * 4 # VALID
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class H100_SXM_80GB_TP2x2_HighAccuracy(H100_SXM_80GB_TP2x2):
    pass
...
class H100_SXM_80GB_TP2x4_HighAccuracy_MaxQ(H100_SXM_80GB_TP2x4_MaxQ):
    ...
    #server_target_qps = 16.1 * 4
    #server_target_qps = 17.25 * 4
    #server_target_qps = 17.825 * 4 # VALID
    #server_target_qps = 18.1125 * 4 # INVALID,
    server_target_qps = 17.96875 * 4 # VALID,
