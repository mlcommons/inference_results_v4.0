...
class H100_SXM_80GBx8(H100_SXM_80GBx1):
    ...
    #server_target_qps = 10.275
    #server_target_qps = 11.9875
    #server_target_qps = 12.84375
    #server_target_qps = 13.271875 
    server_target_qps = 13.4859375
    #server_target_qps = 13.59296875
