...
### Accuracy Results 
`ROUGE1`: `43.04`, Required accuracy for closed division `>= 42.94351`
`ROUGE2`: `20.1313`, Required accuracy for closed division `>= 20.10338`
`ROUGEL`: `29.9733`, Required accuracy for closed division `>= 29.95811`
...
### Power Results 
`Power consumed`: `542.947 Watts`, `Power efficiency`: `8.586 samples per Joule`