...
cm pull repo ctuning@mlcommons-ck --checkout=ab3a6a28603bacea784265bbe3e3b509b65133b4
...
cm run script \
	...
	--gpu_name=rtx_4090 \
	--adr.mlperf-inference-implementation.tags=_num_gpus.2
```
...
### Accuracy Results 
`WER`: `92.56128`, Required accuracy for closed division `>= 91.62252`

### Performance Results 
`90th percentile latency (ns)`: `10344033.0`
