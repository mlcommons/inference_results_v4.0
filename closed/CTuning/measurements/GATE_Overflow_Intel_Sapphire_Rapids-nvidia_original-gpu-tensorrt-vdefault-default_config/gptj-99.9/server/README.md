...
### Accuracy Results 
`ROUGE1`: `43.0003`, Required accuracy for closed division `>= 42.94351`
`ROUGE2`: `20.1351`, Required accuracy for closed division `>= 20.10338`
`ROUGEL`: `29.9644`, Required accuracy for closed division `>= 29.95811`
