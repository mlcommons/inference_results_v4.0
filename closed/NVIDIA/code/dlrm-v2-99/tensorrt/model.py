...
class DLRMv2TRTNetwork:
    def __init__(self,
                 ...
                 bot_mlp_precision_override: str = None,
                 interaction_op_precision_override: str = None,
                 top_mlp_precision_override: str = None,
                 final_linear_precision_override: str = None):
        ...
        # TODO(vir): fix precision x reduced_precision_io flags
        str_to_precision = {'fp32': trt.float32, 'fp16': trt.float16, 'int8': trt.int8}
        self.bot_mlp_precision = str_to_precision[bot_mlp_precision_override] if bot_mlp_precision_override else self.bot_mlp_precision
        self.interaction_op_precision = str_to_precision[interaction_op_precision_override] if interaction_op_precision_override else self.interaction_op_precision
        self.top_mlp_precision = str_to_precision[top_mlp_precision_override] if top_mlp_precision_override else self.top_mlp_precision
        self.final_linear_precision = str_to_precision[final_linear_precision_override] if final_linear_precision_override else self.final_linear_precision
...
class DLRMv2EngineBuilderOp(CalibratableTensorRTEngine,
    ...
    def __init__(self,
        ...
        # precision overrides
        assert bot_mlp_precision_override in ['fp32', 'fp16', 'int8', None]
        assert interaction_op_precision_override in ['fp32', 'fp16', 'int8', None]
        assert top_mlp_precision_override in ['fp32', 'fp16', 'int8', None]
        assert final_linear_precision_override in ['fp32', 'fp16', 'int8', None]
        self.bot_mlp_precision_override = bot_mlp_precision_override
        self.interaction_op_precision_override = interaction_op_precision_override
        self.top_mlp_precision_override = top_mlp_precision_override
        self.final_linear_precision_override = final_linear_precision_override
    ...
    def create_network(self, builder: trt.Builder):
        dlrm_network = DLRMv2TRTNetwork(batch_size=self.batch_size,
                                        ...
                                        bot_mlp_precision_override=self.bot_mlp_precision_override,
                                        interaction_op_precision_override=self.interaction_op_precision_override,
                                        top_mlp_precision_override=self.top_mlp_precision_override,
                                        final_linear_precision_override=self.final_linear_precision_override)
