...
class L40X2(SingleStreamGPUBaseConfig):
    system = KnownSystem.L40x2
...
class L40X2_HighAccuracy(L40X2):
    precision = "fp16"
    single_stream_expected_latency_ns = L40X2.single_stream_expected_latency_ns * 2


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class L40X2_Triton(L40X2):
    use_triton = True
...
class L40X2_HighAccuracy_Triton(L40X2_HighAccuracy):
    use_triton = True
