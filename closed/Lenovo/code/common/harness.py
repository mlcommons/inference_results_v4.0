...
from code.common.log_parser import from_loadgen_by_keys, scenario_loadgen_log_keys, get_loadgen_log_keys
...
with ScopedRestrictedImport(_new_path):
    ...
    # TODO: Remove this once SDXL is added to the submission checker
    benchmark_qsl_size_map["sdxl"] = 5000
...
class BaseBenchmarkHarness:
    ...
    def run_harness(self, flag_dict=None, skip_generate_measurements=False):
        ...
        loadgen_query_keys = ["result_validity", scenario_key, "early_stopping_met", "effective_samples_per_query"]
        ...
        satisfies_query_constraint = float(results.get("effective_samples_per_query", "0.0")) \
