...
scenario_loadgen_log_keys_for_token_measurement: Final[Dict[str, str]] = {
    ...
    Scenario.Server: "result_scheduled_samples_per_sec",
    # TODO: Add token latency here as well.
    Scenario.SingleStream: "result_90.00_percentile_latency_ns",
    Scenario.MultiStream: "result_99.00_percentile_per_query_latency_ns",
}
...
def get_loadgen_log_keys(scenario: Scenario, benchmark: Benchmark = None) -> str:
    ...
    """
    if benchmark is None or benchmark != Benchmark.LLAMA2:
        return scenario_loadgen_log_keys[scenario]
    else:
        return scenario_loadgen_log_keys_for_token_measurement[scenario]


def perf_metric_from_scenario(system_id: str, scenario: str, benchmark: Benchmark = None):
    """
