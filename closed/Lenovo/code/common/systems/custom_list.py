...
custom_systems['L4x1'] = SystemConfiguration(host_cpu_conf=CPUConfiguration(layout={CPU(name="Intel(R) Xeon(R) D-2733NT CPU @ 2.10GHz", architecture=CPUArchitecture.x86_64, core_count=8, threads_per_core=2): 1}), host_mem_conf=MemoryConfiguration(host_memory_capacity=Memory(quantity=131.488396, byte_suffix=ByteSuffix.GB), comparison_tolerance=0.05), accelerator_conf=AcceleratorConfiguration(layout={KnownGPU.L4.value: 1}), numa_conf=None, system_id="L4x1")
