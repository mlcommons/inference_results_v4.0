...
class GPTJ6BEngineBuilderOp(TRTBuilder,
    ...
    def __init__(self,
                 ...
                 fp8_quant_model_path: str = "build/models/GPTJ-6B/fp8-quantized-ammo/GPTJ-FP8-quantized-01292024",
        ...
        if self.use_fp8:
            if not self.fp8_quant_model_path.exists():
                raise FileNotFoundError(f"Could not locate GPT-J fp8 quantized checkpoint model path: ({self.fp8_quant_model_path})")
