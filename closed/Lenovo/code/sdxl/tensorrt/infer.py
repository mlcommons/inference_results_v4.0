...
from code.sdxl.tensorrt.backend import (
    SDXLEngine,
    SDXLBufferManager,
)
...
class TRTTester(BaseTester):
    def __init__(self,
        ...
        self.models = {
            ...
            'clip2': CLIPWithProj(max_batch_size=batch_size, precision='fp16', device=self.device),
    ...
    def _initialize(self, scenario: str = "Offline"):
        ...
        for name, model in self.models.items():
            engine_name = f"sdxl-{model.name}-{scenario}-gpu-b{self.batch_size}-{model.precision}.custom_k_99_MaxP.plan"
...
def main():
    ...
    # python3 -m code.sdxl.tensorrt.infer --engine-dir=/work/build/engines/DGX-H100_H100-SXM-80GBx1/sdxl/Offline/ --batch-size=1 --num-samples=1 --latent-dtype=fp16
    # To run the Torch tester:
    # python3 -m code.sdxl.tensorrt.infer --pytorch-dir=/work/build/models/SDXL/pytorch_models/ --batch-size=2 --num-samples=4 --latent-dtype=fp16
