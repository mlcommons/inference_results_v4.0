...
from code.sdxl.tensorrt.backend import SDXLServer
...
class SDXLHarness(BaseBenchmarkHarness):
    ...
    def _get_harness_executable(self):
        ...
        return "code/sdxl/tensorrt/harness.py"

    def _construct_terminal_command(self, argstr):
        cmd = f"{self.executable.replace('code/sdxl/tensorrt/harness.py', 'python3 -m code.sdxl.tensorrt.harness')} {argstr}"
        return cmd
    ...
    def enumerate_engines(self):
        pipeline_models = [
            ...
            CLIPWithProj(max_batch_size=self.args["gpu_batch_size"], precision='fp16'),
