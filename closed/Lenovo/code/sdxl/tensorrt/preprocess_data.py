...
from code.sdxl.tensorrt.network import make_tokenizer
...
def preprocess_mscoco2014_sdxl(data_dir, model_dir, preprocessed_data_dir):
    ...
    ckpt_path_clip1 = Path(model_dir, "SDXL/official_pytorch/fp32/stable_diffusion_fp32/checkpoint_pipe/tokenizer")
    ckpt_path_clip2 = Path(model_dir, "SDXL/official_pytorch/fp32/stable_diffusion_fp32/checkpoint_pipe/tokenizer_2")
