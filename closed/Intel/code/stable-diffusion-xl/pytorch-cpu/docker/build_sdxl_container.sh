...
VERSION=4.0
export IMAGE_NAME=mlperf_inference_sdxl_bf16:${VERSION}



echo "Building Stable Diffusion XL workflow container"
DOCKER_BUILDKIT=1 docker build --progress=plain ${DOCKER_BUILD_ARGS} -f Dockerfile -t ${IMAGE_NAME} ../../../../
