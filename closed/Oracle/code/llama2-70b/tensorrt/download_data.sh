...
if [ -e /work/code/gptj/llama2/download_data.sh ]
then
    echo "Inside container, start downloading..."
    echo "The llama2 download is not automatable. Please visit: https://docs.google.com/forms/d/e/1FAIpQLSc_8VIvRmXM3I8KQaYnKf7gy27Z63BBoI_I1u02f4lw6rBp3g/viewform to sign and download the dataset."
else
